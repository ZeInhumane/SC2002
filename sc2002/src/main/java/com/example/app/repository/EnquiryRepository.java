...
/**
 * Repository class for Enquiry. This class extends the GeneralRepository class to provide CRUD operations for Enquiry
 * objects.
 *
...
public class EnquiryRepository extends GeneralRepository<Enquiry> {
    ...
    /**
     * Constructor for EnquiryRepository. Initializes the repository with the Enquiry serializer and the file name.
     *
