 ...
 * This class extends the GeneralRepository class to provide CRUD operations for User objects.
 *
...
public class UserRepository extends GeneralRepository<User> {
     ...
     * Initializes the repository with the User serializer and the file name.
     *
