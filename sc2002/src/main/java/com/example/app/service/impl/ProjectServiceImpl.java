...
/**
 * Implementation of the ProjectService interface. Provides functionality to manage housing projects including creating,
 * updating, deleting, retrieving by various conditions, and assigning officers or updating flat counts.
 *
 * @see ProjectService
 */
public class ProjectServiceImpl implements ProjectService {
     ...
     * @param officers
     *            assigned officer IDs
     * @param groups
     *            target marital status groups
     * @param flats
     *            available flat types and counts
    ...
    public Project createProject(String projectName, Date applicationOpenDate, Date applicationCloseDate,
            String neighborhood, int managerId, boolean visibility, Integer officerLimit, Set<Integer> officers,
        ...
        Project project = new Project(null, projectName, stripTime(applicationOpenDate),
                stripTime(applicationCloseDate), neighborhood, managerId, visibility, officerLimit, officers, groups,
                flats);
     ...
     *            the project ID
     * @param officerId
     *            the officer ID to add
     * @return the updated Project object
     * @throws IOException
     *             if an I/O error occurs
     * @throws IllegalArgumentException
     *             if project is not found or officer limit is exceeded
     */
    @Override
