...
/**
 * Service interface for managing projects and registrations. This interface extends the UserService interface. It
 * provides methods for managing project creation, updating, visibility toggling, registration status updates, and
...
public interface ManagerService extends UserService {
     ...
     *             if project creation fails due to time overlap
     */
    Project createProject(Manager manager, String projectName, Date applicationOpenDate, Date applicationCloseDate,
            String neighborhood, boolean visibility, Integer officerLimit, Set<Integer> officers,
            Set<MaritalStatus> groups, Map<FlatType, Integer> flats) throws IOException, IllegalStateException;
    ...
    /**
     * Check if a project belongs to the manager. Since the manager can own multiple projects
     *
     * @param manager
     *            the manager
     * @param projectId
     ...
     */
    void updateRegistrationStatus(Manager manager, int registrationId, RegistrationStatus status)
     ...
     *             if the project does not belong to the manager
     */
    List<Application> getApplicationsOfProject(Manager manager, Integer projectId)
     ...
     * @param flatType
     *            the type of flat applied for
     * @param projectName
     *            the name of the project
     * @param minAge
     *            the minimum age of the applicant
     * @param maxAge
     *            the maximum age of the applicant
     * @throws IOException
     *             if an I/O error occurs
     */
    List<ApplicantBookingReportRow> getBookedApplicationsReport(MaritalStatus maritalStatus, FlatType flatType,
