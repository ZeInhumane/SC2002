...
public class ManagerServiceImpl extends UserServiceImpl implements ManagerService {
     ...
     * @param maritalStatus the marital status to filter by (can be null)
     * @param flatType the flat type to filter by (can be null)
     * @param projectName the project name to filter by (can be null)
     * @param minAge the minimum age to filter by (can be null)
     * @param maxAge the maximum age to filter by (can be null)
