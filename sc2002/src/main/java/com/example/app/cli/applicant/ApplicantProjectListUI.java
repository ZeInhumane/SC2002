...
public class ApplicantProjectListUI {
    ...
    public ApplicantProjectListUI(ApplicantControl ctrl, ProjectFilter filter) {
        this.ctrl = ctrl;
        this.filter = filter;
    }
    ...
    private void showProjects() {
        List<Project> projects = getFilteredProjects();
        new PaginatedUI<>(Helper.toHeader("Available Projects"), () -> projects, this::handleProjectSelection, 5, "No suitable projects found.").run();
    }
