...
/**
 * Officer class that represents an officer in the system.
 * It extends the Applicant class
 * Officer can do what an applicant can do, but also has additional properties
 * Officer can register to be an officer for a project
 * Officer can book a flat upon successful application of an applicant
 * Provides methods to get and set officer details.
 *
 * @see Applicant
 */
public class Officer extends Applicant {
     ...
     *
     * @param id             the ID of the officer. This field should be null for new officers. After saving to the database, it will be set.
     ...
     * @param flatType       the flat type of the officer
     * @param applicationId  the application ID of the officer
     * @param registeredId   the registration ID of the officer
     * @param projectId      the project ID for which the officer is registered
     */
     ...
     *
     * @param projectId the ID of the project for which the officer is registered
     */
